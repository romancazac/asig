...
export const FormRca = ({ itemsStep }) => {
  ...
  const stepOneSchemas = Yup.object().shape({
    ...
    price:Yup.string().required('Selectati compania')
      ...
      >
        {({  values, isValid}) => (
            <Form>
              ...
              {step === 1 && <RcaStepOne values={values} isValid={isValid} days={360}/>}
              {step === 2 && <RcaStepTwo values={values} isValid={isValid} />}
